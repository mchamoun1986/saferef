...
export const REFRIGERANTS_V5: SeedRefrigerantV5[] = [
  ...
  // ── Additional refrigerants (from V2 product catalog) ──
  { id: 'R123',     name: 'R-123 (HCFC-123)',      safetyClass: 'B1',  toxicityClass: 'B', flammabilityClass: '1',  atelOdl: 0.01,    lfl: null,  practicalLimit: 0.01,  vapourDensity: 6.28, molecularMass: 153,   boilingPoint: '27.8',   gwp: '77',    gasGroup: 'HFC2' },
  { id: 'R125',     name: 'R-125',                  safetyClass: 'A1',  toxicityClass: 'A', flammabilityClass: '1',  atelOdl: 0.39,    lfl: null,  practicalLimit: 0.39,  vapourDensity: 4.93, molecularMass: 120,   boilingPoint: '-48.1',  gwp: '3500',  gasGroup: 'HFC1' },
  { id: 'R227',     name: 'R-227ea (HFC-227ea)',    safetyClass: 'A1',  toxicityClass: 'A', flammabilityClass: '1',  atelOdl: 0.32,    lfl: null,  practicalLimit: 0.32,  vapourDensity: 6.96, molecularMass: 170,   boilingPoint: '-16.3',  gwp: '3220',  gasGroup: 'HFC2' },
  { id: 'R417A',    name: 'R-417A',                  safetyClass: 'A1',  toxicityClass: 'A', flammabilityClass: '1',  atelOdl: 0.36,    lfl: null,  practicalLimit: 0.36,  vapourDensity: 3.82, molecularMass: 106.7, boilingPoint: '-39.3',  gwp: '2346',  gasGroup: 'HFC1' },
  { id: 'R422D',    name: 'R-422D',                  safetyClass: 'A1',  toxicityClass: 'A', flammabilityClass: '1',  atelOdl: 0.34,    lfl: null,  practicalLimit: 0.34,  vapourDensity: 3.97, molecularMass: 109.9, boilingPoint: '-43.2',  gwp: '2729',  gasGroup: 'HFC1' },
  { id: 'R442A',    name: 'R-442A',                  safetyClass: 'A1',  toxicityClass: 'A', flammabilityClass: '1',  atelOdl: 0.25,    lfl: null,  practicalLimit: 0.25,  vapourDensity: 4.00, molecularMass: 97.0,  boilingPoint: '-46.0',  gwp: '1888',  gasGroup: 'HFC1' },
  { id: 'R442D',    name: 'R-442D',                  safetyClass: 'A1',  toxicityClass: 'A', flammabilityClass: '1',  atelOdl: 0.30,    lfl: null,  practicalLimit: 0.30,  vapourDensity: 3.80, molecularMass: 93.0,  boilingPoint: '-45.0',  gwp: '2100',  gasGroup: 'HFC1' },
  { id: 'R453A',    name: 'R-453A',                  safetyClass: 'A1',  toxicityClass: 'A', flammabilityClass: '1',  atelOdl: 0.26,    lfl: null,  practicalLimit: 0.26,  vapourDensity: 4.30, molecularMass: 105.0, boilingPoint: '-42.0',  gwp: '1765',  gasGroup: 'HFC2' },
  { id: 'R507',     name: 'R-507 (R-507A)',          safetyClass: 'A1',  toxicityClass: 'A', flammabilityClass: '1',  atelOdl: 0.53,    lfl: null,  practicalLimit: 0.53,  vapourDensity: 4.08, molecularMass: 98.9,  boilingPoint: '-46.7',  gwp: '3985',  gasGroup: 'HFC1' },
  { id: 'R600',     name: 'R-600 (n-Butane)',        safetyClass: 'A3',  toxicityClass: 'A', flammabilityClass: '3',  atelOdl: 0.0059,  lfl: 0.044, practicalLimit: 0.008, vapourDensity: 2.38, molecularMass: 58.1,  boilingPoint: '-0.5',   gwp: '4',     gasGroup: 'HC' },
  { id: 'Ethanol',  name: 'Ethanol (C2H5OH)',        safetyClass: 'N/A', toxicityClass: 'N/A', flammabilityClass: '3', atelOdl: null,   lfl: 0.033, practicalLimit: 0.007, vapourDensity: 1.59, molecularMass: 46.1,  boilingPoint: '78.4',   gwp: null,    gasGroup: 'VOC' },
