...
export default function Home() {
  ...
  const faqJsonLd = {
    ...
    '@type': 'FAQPage',
    mainEntity: [
      { '@type': 'Question', name: 'Is refrigerant gas detection mandatory?', acceptedAnswer: { '@type': 'Answer', text: 'It depends on the refrigerant type, charge amount, room volume, and risk evaluation per EN 378. In machinery rooms it is generally required. For A2L and A3 flammable refrigerants, detection is almost always recommended and most of the time mandatory.' } },
      ...
      { '@type': 'Question', name: 'How many gas detectors do I need?', acceptedAnswer: { '@type': 'Answer', text: 'It depends on room size, refrigerant type, charge amount, and leak source locations. The manufacturer provides guidance — our baseline is 1 detector per 50 m\u00B2, but cluster-based calculation around leak sources is more accurate.' } },
