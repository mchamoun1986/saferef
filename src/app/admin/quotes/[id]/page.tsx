...
export default function QuoteDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (notFound || !quote) {
    return (
      <div className="max-w-2xl mx-auto px-6 py-16 text-center">
        ...
        <Link href="/admin/quotes" className="inline-flex items-center gap-2 text-[#16354B] hover:underline font-medium">
          &larr; Back to quotes
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
      ...
      {/* ── Header ──────────────────────────────────────────────────────── */}
      <div>
        <Link href="/admin/quotes" className="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-[#16354B] transition-colors mb-4">
          &larr; Back to quotes
        </Link>
