    ...
    <div className="min-h-screen bg-[#f0f4f8]">
      ...
      <nav className="bg-gradient-to-r from-[#16354B] to-[#1e4a6a] border-b-2 border-[#A7C031] px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <a
            href="/sales"
            className="px-4 py-1.5 rounded text-sm text-gray-300 hover:bg-white/10 transition-colors"
          >
            Dashboard
          </a>
          <a
          ...
          <a
            href="/selector"
            className="px-4 py-1.5 rounded text-sm font-medium text-[#0a1628] bg-[#A7C031] hover:bg-[#8fa828] transition-colors ml-2"
          >
            New Quote &rarr;
          </a>
        </div>
